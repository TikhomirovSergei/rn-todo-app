...
export const TodoState = ({ children }) => {
    ...
    const addTodo = async title => {
        clearError()
        try {
            const data = await Http.post("https://rn-todo-app-a50fd.firebaseio.com/todos.json", { title })
    ...
    const fetchTodos = async () => {
        ...
        clearError()
        try {
            const data = await Http.get("https://rn-todo-app-a50fd.firebaseio.com/todos.json")
